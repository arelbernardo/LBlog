    ...
    if($hasSession) {
        ...
        switch($headFlags) {
            ...
            $otherNavButtons = '
                ...
                <li class=""><a href="'.base_url().'profile/'.$profileName.'">['.$profileName.']</a></li>
        ...
        switch($headFlags) {
            case "Main":
                $otherNavButtons = '<li><a href="'.base_url().'registration"><span class="glyphicon glyphicon-user"></span> Create an Account</a></li>
